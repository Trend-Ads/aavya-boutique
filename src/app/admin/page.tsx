  ...
  return (
    <div style={{ padding: "2rem 1.5rem", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "0.9rem", color: "#6b7280", marginTop: "0.25rem" }}>
            Signed in as <strong>{user.email}</strong> • Admin privileges active
          </p>
        </div>
        ...
        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
          ...
          <a
            href="https://supabase.com/dashboard/project/spdzbnlwowrmuyypcapi"
            target="_blank"
      ...
      >
        ...
        >
          <div style={{ fontSize: "0.8rem", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 500 }}>
            Catalog Products
          </div>
          ...
          <div style={{ fontSize: "0.8rem", color: "#10b981", marginTop: "0.35rem", display: "flex", alignItems: "center", gap: "0.3rem" }}>
            <span>●</span> {inStockCount} currently available
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: "1.25rem", fontWeight: 600, color: "#10b981", marginTop: "0.6rem", display: "flex", alignItems: "center", gap: "0.4rem" }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2z" />
            </svg>
            Direct WhatsApp
          </div>
          <div style={{ fontSize: "0.8rem", color: "#6b7280", marginTop: "0.45rem" }}>
            +91 85940 31993
          </div>
        </div>
      </div>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: "0.82rem", color: "#6b7280", marginTop: "0.15rem" }}>
              Manage products displayed across the storefront
            </p>
          </div>
